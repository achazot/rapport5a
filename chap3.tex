...
\label{ch:condev}
	...
	\section{Visualisation et interaction utilisateur}
		...
		\subsection{Présentation vidéo et incrustation}
			...
			\end{itemize}
			\change[inline]{Ajouter même figure et explication de comment j'ai fait}
			
			Il est alors possible d'utiliser cette structure d'encapsulation des résultats pour des traitements ultérieurs, par exemple retrouver ces objets sur la cartographie des lieux.
