\chapter{Un système de détection omnidirectionnel en temps réel}
	...
	\section{Etat de l'art}
		...
		\subsection{Vidéo sphérique}
			...
			Notre choix s'était d'abord porté sur le produit Insta\oldstylenums{360} 4K\cite{insta360}, qui possède un système d'assemblage en temps réel intégré, mais le produit n'étant pas disponible au moment de l'achat, nous avons dûs nous reporter sur la caméra Theta S de Ricoh\cite{ricohthetas}, possédant une qualité d'image moindre et aucun moyen natif d'assemblage en temps réel sous systèmes linux.
